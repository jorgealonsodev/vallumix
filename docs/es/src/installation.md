...
Descarga el último paquete `.deb` desde la página de [GitHub Releases](https://github.com/jorgealonsodev/vallumix/releases):
...
Descarga el último paquete `.rpm` desde la página de [GitHub Releases](https://github.com/jorgealonsodev/vallumix/releases):
