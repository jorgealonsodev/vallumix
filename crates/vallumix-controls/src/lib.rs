...
pub fn registry() -> HashMap<String, Box<dyn Control>> {
    ...
    m.insert(
        "1.1.1.1".into(),
        Box::new(filesystem::disable_cramfs::DisableCramfs::new()),
    );
    m.insert(
        "1.1.1.2".into(),
        Box::new(filesystem::disable_freevxfs::DisableFreevxfs::new()),
    );
    m.insert(
        "1.1.1.3".into(),
        Box::new(filesystem::disable_jffs2::DisableJffs2::new()),
    );
    m.insert(
        "1.1.1.4".into(),
        Box::new(filesystem::disable_hfs::DisableHfs::new()),
    );
    m.insert(
        "1.1.1.5".into(),
        Box::new(filesystem::disable_hfsplus::DisableHfsplus::new()),
    );
    m.insert(
        "1.1.1.6".into(),
        Box::new(filesystem::disable_squashfs::DisableSquashfs::new()),
    );
    m.insert(
        "1.1.1.7".into(),
        Box::new(filesystem::disable_udf::DisableUdf::new()),
    );
    m.insert(
        "1.1.10".into(),
        Box::new(filesystem::disable_usb_storage::DisableUsbStorage::new()),
    );
    m.insert(
        "1.1.2.1".into(),
        Box::new(filesystem::harden_tmpfs::HardenTmpfs::new()),
    );

    // Service controls
    m.insert(
        "2.2.2".into(),
        Box::new(services::disable_cups::DisableCups::new()),
    );
    m.insert(
        "2.2.3".into(),
        Box::new(services::disable_avahi::DisableAvahi::new()),
    );
    m.insert(
        "2.2.4".into(),
        Box::new(services::disable_dhcp::DisableDhcp::new()),
    );
    m.insert(
        "2.2.5".into(),
        Box::new(services::disable_ldap::DisableLdap::new()),
    );
    m.insert(
        "2.2.6".into(),
        Box::new(services::disable_nfs::DisableNfs::new()),
    );
    m.insert(
        "2.2.7".into(),
        Box::new(services::disable_rpcbind::DisableRpcbind::new()),
    );
    m.insert(
        "2.2.8".into(),
        Box::new(services::disable_bind::DisableBind::new()),
    );
    m.insert(
        "2.2.9".into(),
        Box::new(services::disable_vsftpd::DisableVsftpd::new()),
    );
    m.insert(
        "2.2.10".into(),
        Box::new(services::disable_httpd::DisableHttpd::new()),
    );
    m.insert(
        "2.2.11".into(),
        Box::new(services::disable_dovecot::DisableDovecot::new()),
    );
    m.insert(
        "2.2.12".into(),
        Box::new(services::disable_xinetd::DisableXinetd::new()),
    );
    m.insert(
        "2.2.14".into(),
        Box::new(services::disable_snmpd::DisableSnmpd::new()),
    );
    m.insert(
        "2.2.15".into(),
        Box::new(services::disable_rsync::DisableRsync::new()),
    );

    // Network controls
    m.insert(
        "3.1.1".into(),
        Box::new(network::sysctl_ip_forwarding::SysctlIpForwarding::new()),
    );
    m.insert(
        "3.1.2".into(),
        Box::new(network::sysctl_disable_send_redirects::SysctlDisableSendRedirects::new()),
    );
    m.insert(
        "3.2.1".into(),
        Box::new(network::sysctl_disable_source_route::SysctlDisableSourceRoute::new()),
    );
    m.insert(
        "3.2.2".into(),
        Box::new(network::sysctl_disable_accept_redirects::SysctlDisableAcceptRedirects::new()),
    );
    m.insert(
        "3.2.3".into(),
        Box::new(network::sysctl_disable_icmp_redirects::SysctlDisableIcmpRedirects::new()),
    );
    m.insert(
        "3.2.6".into(),
        Box::new(network::sysctl_enable_rp_filter::SysctlEnableRpFilter::new()),
    );
    m.insert(
        "3.2.7".into(),
        Box::new(network::sysctl_enable_syncookies::SysctlEnableSyncookies::new()),
    );
    m.insert(
        "3.3.1".into(),
        Box::new(network::configure_firewalld::ConfigureFirewalld::new()),
    );

    // Logging controls
    m.insert(
        "4.1.1.1".into(),
        Box::new(logging::EnsureRsyslogInstalled::new()),
    );
    m.insert(
        "4.1.1.2".into(),
        Box::new(logging::EnsureRsyslogConfigured::new()),
    );
    m.insert(
        "4.1.1.3".into(),
        Box::new(logging::EnsureRsyslogPerms::new()),
    );
    m.insert(
        "4.1.2.1".into(),
        Box::new(logging::EnsureJournaldConfigured::new()),
    );
    m.insert(
        "4.1.2.2".into(),
        Box::new(logging::EnsureJournaldOverride::new()),
    );
    m.insert(
        "4.1.3.1".into(),
        Box::new(logging::EnsureAuditdInstalled::new()),
    );
    m.insert(
        "4.1.3.2".into(),
        Box::new(logging::EnsureAuditdConfigured::new()),
    );
    m.insert(
        "4.1.4.1".into(),
        Box::new(logging::EnsureAuditIdentityRules::new()),
    );
    m.insert(
        "4.1.4.2".into(),
        Box::new(logging::EnsureAuditLoginEvents::new()),
    );
    m.insert(
        "4.1.4.3".into(),
        Box::new(logging::EnsureAuditSessionEvents::new()),
    );
    ...
    m.insert(
        "5.2.1".into(),
        Box::new(ssh::ssh_ensure_protocol_2::SshEnsureProtocol2::new()),
    );
    m.insert(
        "5.2.2".into(),
        Box::new(ssh::ssh_set_loglevel::SshSetLoglevel::new()),
    );
    m.insert(
        "5.2.3".into(),
        Box::new(ssh::ssh_disable_empty_passwords::SshDisableEmptyPasswords::new()),
    );
    m.insert(
        "5.2.4".into(),
        Box::new(ssh::disable_root_login::SshDisableRootLogin::new()),
    );
    m.insert(
        "5.2.4b".into(),
        Box::new(ssh::ssh_max_auth_tries::SshMaxAuthTries::new()),
    );
    m.insert(
        "5.2.6".into(),
        Box::new(ssh::ssh_client_alive_interval::SshClientAliveInterval::new()),
    );
    m.insert(
        "5.2.7".into(),
        Box::new(ssh::ssh_login_grace_time::SshLoginGraceTime::new()),
    );
    m.insert(
        "5.2.8".into(),
        Box::new(ssh::ssh_limit_access::SshLimitAccess::new()),
    );
    m.insert(
        "5.2.9".into(),
        Box::new(ssh::ssh_set_banner::SshSetBanner::new()),
    );
    m.insert(
        "5.2.10".into(),
        Box::new(ssh::ssh_disable_x11_forwarding::SshDisableX11Forwarding::new()),
    );
    m.insert(
        "5.2.11".into(),
        Box::new(ssh::ssh_set_crypto_policy::SshSetCryptoPolicy::new()),
    );
    ...
    m.insert(
        "5.3.1".into(),
        Box::new(auth::EnsurePamPasswordQuality::new()),
    );
    ...
    m.insert(
        "6.1.1".into(),
        Box::new(maintenance::ensure_perms_passwd::EnsurePermsPasswd::new()),
    );
    m.insert(
        "6.1.2".into(),
        Box::new(maintenance::EnsurePermsShadow::new()),
    );
    m.insert(
        "6.1.3".into(),
        Box::new(maintenance::EnsurePermsGroup::new()),
    );
    m.insert(
        "6.1.4".into(),
        Box::new(maintenance::EnsurePermsGshadow::new()),
    );
    ...
    m.insert(
        "6.1.9".into(),
        Box::new(maintenance::EnsureCronPerms::new()),
    );
...
mod tests {
    ...
    fn profile_web_toml_contains_pilot_controls() {
        ...
        let profile =
            vallumix_core::profile::Profile::from_file(&path).expect("web.toml should parse");
    ...
    fn pilot_controls_resolve_from_registry() {
        ...
        let resolved = profile
            .resolve_controls(&reg)
            .expect("should resolve pilot controls");
    ...
    fn profile_web_resolves_all_controls() {
        ...
        let resolved = profile
            .resolve_controls(&reg)
            .expect("all web controls should resolve");
    ...
    fn profile_database_resolves_all_controls() {
        ...
        let profile =
            vallumix_core::profile::Profile::from_file(&path).expect("database.toml should parse");
        let reg = registry();
        let resolved = profile
            .resolve_controls(&reg)
            .expect("all database controls should resolve");
        assert_eq!(resolved.len(), profile.controls.len());
        assert!(profile.controls.len() >= 20);
    }
    ...
    fn profile_bastion_resolves_all_controls() {
        ...
        let profile =
            vallumix_core::profile::Profile::from_file(&path).expect("bastion.toml should parse");
        let reg = registry();
        let resolved = profile
            .resolve_controls(&reg)
            .expect("all bastion controls should resolve");
        assert_eq!(resolved.len(), profile.controls.len());
    ...
    fn profile_counts_differ() {
        let workspace_root = PathBuf::from(env!("CARGO_MANIFEST_DIR"))
            ...
            .to_path_buf();
        let web =
            vallumix_core::profile::Profile::from_file(workspace_root.join("profiles/web.toml"))
                .unwrap();
        let db = vallumix_core::profile::Profile::from_file(
            workspace_root.join("profiles/database.toml"),
        )
        .unwrap();
        let bastion = vallumix_core::profile::Profile::from_file(
            workspace_root.join("profiles/bastion.toml"),
        )
        .unwrap();
