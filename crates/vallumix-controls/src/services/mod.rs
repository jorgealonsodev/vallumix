    ...
    ($name:ident, $id:expr, $desc:expr, $svc:expr, $sev:expr) => {
        ...
        impl $name {
            ...
            pub fn with_paths(
                ...
                $name(super::common::ServiceDisable::with_paths(
                    $id,
                    $desc,
                    service_name,
                    systemctl_path,
...
pub mod disable_cups {
    def_service_control!(
        DisableCups,
        "2.2.2",
        "Ensure CUPS is not enabled",
        "cups",
        vallumix_core::control::Severity::Low
    );
}
pub mod disable_dhcp {
    def_service_control!(
        DisableDhcp,
        "2.2.4",
